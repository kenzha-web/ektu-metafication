...
export default class Camera extends React.Component {
	...
	fadeCanvasTextOut() {
		...
		setTimeout(() => {
			this.setState({ canvasTextVisible: false })
		}, 1001)
	}
	...
	fadeNavTextOut() {
		...
		setTimeout(() => {
			this.setState({ navTextVisible: false })
		}, 1001)
	}
	...
	introAnimation() {
		...
		setTimeout(() => {
			this.moveToNewView(this.seatCoordinates.S7_1, 3000, 0)
		}, 6000)
		this.fadeNavTextIn()
	}
	...
	render() {
		return (
			<Entity
				id='cameraEntity'
				position={[
					this.state.currentCameraPos.x,
					this.state.currentCameraPos.y,
					this.state.currentCameraPos.z,
				]}
			>
				<Navigation
				...
				<Entity
					visible={this.state.navTextVisible}
					material={{
						color: 'white',
						transparent: true,
						shader: 'flat',
						opacity: this.state.navTextOpacity.x,
					}}
					position={[-5, -2, -8]}
					size={0.01}
				...
				/>
				<Entity
					visible={this.state.canvasTextVisible}
					material={{
						color: 'white',
						transparent: true,
						shader: 'flat',
						opacity: this.state.canvasTextOpacity.x,
					}}
					position={[-5.5, -3.5, -8]}
					size={0.01}
				...
				<Entity
					...
					material={{
						...
						transparent: true,
						shader: 'flat',
						opacity: this.state.textOpacity.x,
					}}
					position={[-9, -4, -8]}
					size={0.01}
