...
export default class BookSeat extends React.Component {
	...
	redirect() {
		window.location = 'http://localhost:8000/basic-audio.html'
	}
	...
	render() {
		return (
			<Entity position={[0, -2, -1.4]} rotation={[-40, 0, 0]}>
				...
				<Entity
					onMouseEnter={this.fadeTextIn}
					onMouseLeave={this.fadeTextOut}
					onClick={this.redirect}
				>
					<a-image src='#book-seat' width='0.8' height='0.5'>
						<Animation
							attribute='width'
							from='0.8'
							to='1'
